...
print img_picto($langs->trans("OpenPR"), 'fontawesome_github-alt_fab_green_1.2em');
print "&nbsp;".$langs->trans("OpenPR").'</th></tr>';
print '<tr><td align="left">'.$langs->trans("PreviousMonth")."</td><td align=right>".$nbopenmonth."</td></tr>";
print '<tr><td align="left">'.$langs->trans("PreviousQuarter")."</td><td align=right>".$nbopenquarter."</td></tr>";	
print '<tr><td align="left">'.$langs->trans("PreviousYear")."</td><td align=right>".$nbopenyear."</td></tr>";
print '<tr><td align="left">'.$langs->trans("PreviousPeriod")."</td><td align=right>".$nbopenrest."</td></tr>";
print '</table>';
...
print '<table class="noborder centpercent">';
print '<tr class="liste_titre"><th colspan=2>';
print img_picto($langs->trans("OpenIssue"), 'fontawesome_github_fab_green_1.2em');
print "&nbsp;".$langs->trans("OpenIssue").'</th></tr>';
print '<tr><td align="left">'.$langs->trans("PreviousMonth")."</td><td align=right>".$nbopenmonth."</td></tr>";
print '<tr><td align="left">'.$langs->trans("PreviousQuarter")."</td><td align=right>".$nbopenquarter."</td></tr>";	
print '<tr><td align="left">'.$langs->trans("PreviousYear")."</td><td align=right>".$nbopenyear."</td></tr>";
print '<tr><td align="left">'.$langs->trans("PreviousPeriod")."</td><td align=right>".$nbopenrest."</td></tr>";
...
print '<table class="noborder centpercent">';
print '<tr class="liste_titre"><th colspan=2>';
print img_picto($langs->trans("ClosedPR"), 'fontawesome_github-alt_fab_red_1.2em');
print "&nbsp;".$langs->trans("ClosedPR").'</th></tr>';
print '<tr><td align="left">'.$langs->trans("PreviousMonth")."</td><td align=right>".$nbopenmonth."</td></tr>";
print '<tr><td align="left">'.$langs->trans("PreviousQuarter")."</td><td align=right>".$nbopenquarter."</td></tr>";	
print '<tr><td align="left">'.$langs->trans("PreviousYear")."</td><td align=right>".$nbopenyear."</td></tr>";
print '<tr><td align="left">'.$langs->trans("PreviousPeriod")."</td><td align=right>".$nbopenrest."</td></tr>";
...
print '<table class="noborder centpercent">';
print '<tr class="liste_titre"><th colspan=2>';
print img_picto($langs->trans("ClosedIssue"), 'fontawesome_github_fab_red_1.2em');
print "&nbsp;".$langs->trans("ClosedIssue").'</th></tr>';
print '<tr><td align="left">'.$langs->trans("PreviousMonth")."</td><td align=right>".$nbopenmonth."</td></tr>";
print '<tr><td align="left">'.$langs->trans("PreviousQuarter")."</td><td align=right>".$nbopenquarter."</td></tr>";	
print '<tr><td align="left">'.$langs->trans("PreviousYear")."</td><td align=right>".$nbopenyear."</td></tr>";
print '<tr><td align="left">'.$langs->trans("PreviousPeriod")."</td><td align=right>".$nbopenrest."</td></tr>";
